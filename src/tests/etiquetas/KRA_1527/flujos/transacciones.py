...
async def ir_a_reportes_transacciones(flow, multi: bool = False, agency: str = None) -> None:
    ...
    # Puerta de entrada a la cancelación: si quedó un diálogo interpuesto (el
    # del recibo digital, por ejemplo), navegar es imposible y cada paso agota
    # su timeout en silencio. Preguntar cuesta milisegundos; no preguntar
    # costaba minutos y hacía parecer que la cancelación era lenta.
