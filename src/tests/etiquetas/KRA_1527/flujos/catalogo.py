...
# Igual que en mt.py: el original resolvía junto a su propio archivo. Al
# copiarlo aquí apuntaba a esta carpeta y el catálogo salía vacío.
_CATALOGO = (Path(settings.PROJECT_ROOT) / "src" / "pagadores" /
             "catalogo_disponibilidad.json")
